  ...
  return (
    <div id="order-modal">
      <section className="order-modal__content">
        <button aria-label="Close" onClick={(e) => modalControl(e)}>
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
          ...
          <button
            onClick={() =>
              swal(
                "Order Placed!",
                `Your order id is:
                It will arrive to Total Look Reforma
                Av. Paseo de la Reforma 222, zona rosa, Juárez, Cuauhtémoc, 06600 Ciudad de México, CDMX`,
                "success"
              )
            }
          >
